          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="z-10 text-left lg:col-span-6 space-y-6">
              ...
              <motion.p {...fadeUp(0.2)}
                ...
                Capy Study giúp sinh viên lưu trữ tài liệu tập trung, tra cứu thông minh với AI, và học nhóm hiệu quả — tất cả trong một nền tảng duy nhất.
              </motion.p>
              ...
              <motion.div {...fadeUp(0.3)} className="flex flex-wrap gap-4 pt-2">
                <Button type="primary" shape="round" size="large"
                  ...
                  Bắt đầu miễn phí <i className="bi bi-arrow-right text-[15px] group-hover:translate-x-1 transition-transform duration-300" />
                </Button>
          ...
          <div className="max-w-3xl mx-auto px-6 md:px-12 text-center relative z-10">
            <motion.div {...fadeUp(0)}>
              ...
              <p className="text-white/80 text-[15px] md:text-[16px] font-medium mb-8 max-w-lg mx-auto leading-relaxed">
                Tham gia cùng hàng trăm sinh viên đang sử dụng Capy Study để quản lý tài liệu và học tập hiệu quả hơn mỗi ngày.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Button shape="round" size="large"
                  ...
                  Đăng ký miễn phí <i className="bi bi-arrow-right text-[15px] group-hover:translate-x-1 transition-transform duration-300" />
                </Button>
                <Button shape="round" size="large"
