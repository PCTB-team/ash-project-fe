        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-5 text-[15px] font-medium text-[#1d1d1f]/70">
              <button onClick={() => { onNavigate('landing'); setIsMobileMenuOpen(false); }} className="text-left hover:text-[#ff5c00] transition-colors py-2 border-b border-black/[0.03]">Trang chủ</button>
              ...
              <button onClick={() => { onNavigate('login'); setIsMobileMenuOpen(false); }} className="text-left hover:text-[#ff5c00] transition-colors py-2 border-b border-black/[0.03]">Thư viện</button>
              <button onClick={() => { onNavigate('login'); setIsMobileMenuOpen(false); }} className="text-left hover:text-[#ff5c00] transition-colors py-2 border-b border-black/[0.03]">Cộng đồng</button>
              <button onClick={() => { onNavigate('login'); setIsMobileMenuOpen(false); }} className="text-left hover:text-[#ff5c00] transition-colors py-2 border-b border-black/[0.03]">Trợ lý AI</button>
            </div>
